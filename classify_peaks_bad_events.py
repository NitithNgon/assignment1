...
from wheel_width_sample import find_wheel_width_sample
from typing import List
from typing import Optional
from itertools import chain

def classify_peaks_bad_events(flip_axle_cm: np.ndarray, file_path: str, path_component_list: List[str] , collect_peaks_results_dict: dict[str, List[float]] , velocity: Optional[int], raw_time_sec: float) -> dict[str, List[float]]:
