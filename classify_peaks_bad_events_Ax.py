...
def classify_peaks_bad_events_Ax( Ax: np.ndarray,
    ...
    bad_event_above_wheel_Ax_peak, properties_bad_event_above_wheel_Ax_peak = find_peaks(Ax,
    ...
    wheel_Ax_peaks, properties_wheel_bad_event_Ax_peak = find_peaks(Ax,
